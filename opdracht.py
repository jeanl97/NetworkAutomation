...
def getServer():
    print('a. IP en naam toekennen ')
    optie = str(input('Kies "a" om door te gaan of tik m om terug naar het hoofdmenu te keren'))
    if optie == "a":
        serverRegistreren()
    elif optie =="m":
        menu()
...
def getVagrant():
    ...
    optie =str(input('Kies "a" of "b" om door te gaan of tik m om terug naar het hoofdmenu te keren'))
    if optie == 'a':
        vagrantfileMaken()
    elif optie == 'b':
        vagrantBeheren()
...
def getMonitoring():
    ...
    optie =str(input('Kies "a" , "b" , "C" of "d" om door te gaan of tik m om terug naar het hoofdmenu te keren'))
    if optie == 'a':
        diskUsage()
    elif optie == 'b':
        cpuUsage()
